...
public class SocketIOManager implements IOCallback {
    ...
    public void onMessage(String data, IOAcknowledge ack) {
        Log.i(TAG, "onMessage String Server said: " + data);
        if (isHandler()) {
    ...
    public void onMessage(JSONObject json, IOAcknowledge ack) {
        Log.i(TAG, "onMessage Json Server said:" + json.toString());
        if (isHandler()) {
    ...
    public void onJoinResult(JSONObject json, IOAcknowledge ack) {
        Log.i(TAG, "Server said:" + json.toString());
        if (isHandler()) {
            Message msg = sHandler.obtainMessage(SOCKETIO_JOIN_RESULT, json);
            sHandler.sendMessage(msg);
        }
    }
    ...
    public void on(String event, IOAcknowledge ack, Object... args) {
        ...
        }else if (event.equals("robo_join_ret")) {
        	onJoinResult((JSONObject) args[0], null);
        }
    }
    ...
    public static final int SOCKETIO_JOIN_RESULT = 9;
}
